...
#ifndef __I3K__TCPGAMESERVER_H
#define __I3K__TCPGAMESERVER_H
...
namespace I3K
{
	...
	class RPCManager;
	class TCPGameServer : public KET::KIO::TCPServer<KET::KIO::SimplePacket>, public ABaseDencoder
	{
	public:
		TCPGameServer(KET::KIO::NetManager &managerNet);
