...
#ifndef __I3K__TCPEXCHANGESERVER_H
#define __I3K__TCPEXCHANGESERVER_H
...
namespace I3K
{
	...
	class TCPExchangeServer : public KET::KIO::TCPServer<KET::KIO::SimplePacket>, public ABaseDencoder
	{
	public:
		TCPExchangeServer(KET::KIO::NetManager &managerNet);
		virtual ~TCPExchangeServer() { }

	public:
		void SetRPCManagerExchangeServer(RPCManagerExchangeServer *pRPCManagerExchangeServer) { m_pRPCManagerExchangeServer = pRPCManagerExchangeServer; }
	...
	private:
		RPCManagerExchangeServer* m_pRPCManagerExchangeServer;
	};
}
